    ...
    <div class="row">
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body m-4 px-0 pt-0 pb-2 col-6">
                    ...
                    @csrf
                        ...
                        <div class="form-group w-75">
                            ...
                            <input type="number" name="no_hpM" class="form-control @error('no_hpM') is-invalid @enderror"
                        ...
                        <div class="form-group w-75">
                            ...
                            <div class="valid-feedback">
                                *Berkas sesuai yang format yang diminta
                            </div>
                        ...
                        <div class="form-group w-75">
                            ...
                            <input type="file" name="f_ktp"
                                class="form-control is-valid @error('f_ktp') is-invalid @enderror" id="file-open"
                                onchange="previewFile()">
                        ...
                        <div class="text-center">
                            <button type="submit"
                                class="text-white btn btn-lg bg-success btn-lg w-75 mt-4 mb-0">Simpan</button>
                        </div>
                    </form>
