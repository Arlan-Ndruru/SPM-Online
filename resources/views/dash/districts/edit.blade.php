            ...
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <div class="form col-md-6 mx-4">
                        <form role="form" method="POST" action="{{route('dashDistrictUpdate',$district->slug)}}"
                            ...
                            <div class="form-group w-75">
                                ...
                                <input type="text" hidden id="slug" name="slug" class="form-control @error('slug') is-invalid @enderror"
                                    required value="{{old('slug', $district->slug)}}">
                                @error('slug')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-group w-75">
                                ...
                                <input type="text" readonly name="kota" class="form-control @error('kota') is-invalid @enderror"
                                    required value="{{old('kota', $district->kota)}}">
                                @error('kota')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                            ...
                            <div class="form-group w-75">
                                ...
                                <input type="text" name="ket" class="form-control @error('ket') is-invalid @enderror" value="{{ old('ket', $district->ket) }}" >
                                @error('ket')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
