        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    <a href="{{ route('dashboard') }}" class="m-3 btn btn-success">Back</a>
                    <div class="form col-md-6 mx-4">
                        <form role="form" method="POST" action="{{route('dashupdatebyMustahik', $mustahik->slug)}}"
                            ...
                            <div class="form-group w-75">
                                ...
                                <input readonly type="text" id="unique_number" name="unique_number" class="form-control is-valid @error('unique_number') is-invalid @enderror" required
                                maxlength="16"
